...
import { ActionIcon, Card, Code, Group, Modal, Stack, Tabs, Text, Title } from "@mantine/core";
...
import { IconEditCircle, IconEye, IconInfoCircle, IconTrash } from "@tabler/icons-react";
                        ...
                        <Stack gap="md">
                            ...
                            >
                                {instructions.map((instruction) => (
                                    <Reorder.Item
                                        key={instruction.fieldId}
                                        value={instruction}
                                    >
                                        <Card withBorder shadow="sm" p="xs" className="cursor-pointer">
                                                ...
                                                <ActionIcon
                                                    ...
                                                    onClick={() =>
                                                        setInstructions((prev) =>
                                                            prev.filter((p) => p.fieldId !== instruction.fieldId)
                                                        )
                                                    }
                                                >
                                                    <IconTrash />
