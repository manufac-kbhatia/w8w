...
export const Credentials = () => {
    ...
    return (
        <Stack>
            ...
            <Modal
                ...
                title={
                    <Group>
                        ...
                        <Title order={2}>{selectedCredentialSchema?.name}</Title>
                    </Group>
                }
            >
                <Stack>
            ...
            <Group justify="flex-end">
                <Button onClick={openCreateCredModal}>
                    Create Credentials
                </Button>
            </Group>
            {loadingCredentials ? (
                ...
                <Stack>
                    {credentials.map((credential) => {
                        const name: string =
                            ...
                            "";
                        const description = credential.data?.parameters?.description as string | undefined
                        return (
                            <Card
                                key={credential.id}
                                shadow="sm"
                                ...
                                <Group justify="space-between" align="center">
                                    <Group>
                                        ...
                                        <Stack gap={0}>
                                            ...
                                            {description && <Text className="text-xs text-neutral-500">{description}</Text>}
                                            <Group>
                                                <Text>
                                                    Last updated at{" "}
